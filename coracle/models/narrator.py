...
narrator turns a structured :class:`~coracle.runtime.status.Snapshot`
...
class Narrator:
    ...
    def narrate(self, snapshot: Any) -> str:
        ...
        Args:
            snapshot: A :class:`~coracle.runtime.status.Snapshot`
        ...
        Raises:
            RuntimeError: If the narrator is disabled. Callers should
                ...
                :func:`coracle.runtime.status_b.status_b`, which
