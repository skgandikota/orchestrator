"""Native FastAPI router for the coracle (issue #15).
...
from coracle.runtime.status import snapshot as build_snapshot
from coracle.runtime.status_b import status_b as build_status_b
...
class JobManager:
    ...
    def status_payload(self, job: Job, mode: str) -> dict[str, Any]:
        ...
        Modes mirror the three coracle status modes:
