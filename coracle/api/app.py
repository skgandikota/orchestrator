"""FastAPI application factory for the coracle HTTP surface.
...
from coracle.api.embeddings import router as embeddings_router
from coracle.api.openai_compat import build_router
from coracle.api.tasks import router as tasks_router
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="coracle",
        version="0.1.0",
        description="Local-first agent coracle (OpenAI-compatible API).",
    )
